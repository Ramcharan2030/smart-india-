  ...
  return (
    ...
    >
      <div ref={textRef} className="flex flex-col items-center gap-6">
        <div className="text-[var(--champagne)] font-display text-3xl tracking-[0.4em] font-light">
          SMART INDIA REALTORS
        </div>
        <div
          className="text-[var(--muted-ink)] text-lg tracking-wide"
          style={{ fontFamily: "var(--font-editorial)", fontStyle: "italic" }}
        >
          Summoning worlds...
        </div>
        <div className="w-64 h-[1px] bg-white/10 mt-4 relative overflow-hidden">
          <div
            ref={barRef}
